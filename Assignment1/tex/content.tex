...
\mathcal{N} (x|\mu_A,\sigma_A^2) &= \frac{1}{\sqrt{2\pi\sigma_A^"}} e^{-\frac{1}{2\sigma_A^2}(x-\mu_A)^2}

\mathcal{N} (x|\mu_B,\sigma_B^2) &= \frac{1}{\sqrt{2\pi\sigma_B^"}} e^{-\frac{1}{2\sigma_B^2}(x-\mu_B)^2}
