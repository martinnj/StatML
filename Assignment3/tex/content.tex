...
We used the following numbers for $C$ and $\gamma$: $C = (0.01, 0.1, 1.0, 10 100
1000 10000)$ and $\gamma = (0.0001, 0.001, 0.01, 0.1, 1, 10, 100)$. For both the
normalized and raw data, we found that the best $C = 10$ NS $\Gamma = 0.1$
produced the best results. The accuracy on the 
