...
figure;
hold on;
title('x and t of training set plotted with real and predicted target variables of test set.','FontSize', 15);
...
figure;
hold on;
title('Actual(blue) vs. predicted(red) sunspots from 1916 - 2011 using selection 1','FontSize', 15);
legend('Actual sunspots', 'Predicted sunspots');
plot(years, pred_test1, 'r', years, test(:,6), 'b');
hold off;
figure;
hold on;
title('Actual(blue) vs. predicted(red) sunspots from 1916 - 2011 using selection 2','FontSize', 15);
legend('Actual sunspots', 'Predicted sunspots');
plot(years, pred_test2, 'r', years, test(:,6), 'b');
hold off;
figure;
hold on;
title('Actual(blue) vs. predicted(red) sunspots from 1916 - 2011 using selection 3','FontSize', 15);
legend('Actual sunspots', 'Predicted sunspots');
